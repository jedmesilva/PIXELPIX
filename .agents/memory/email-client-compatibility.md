...
**How to apply:** Route new certificate, redemption, and notification templates through the shared compatibility layer, keep the outer body/table backgrounds dark, include `data-ogsc`/`data-ogsb` selectors for the outer canvas and card, and verify both HTML and plain-text alternatives.