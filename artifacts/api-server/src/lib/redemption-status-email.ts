...
function copyForStatus(status: RedemptionNotificationStatus) {
  switch (status) {
    case "approved":
      return {
    ...
    case "rejected":
      return {
        label: "Atualização do resgate",
        headline: "Não foi possível concluir o resgate.",
        description:
          "A solicitação de resgate não foi concluída. Confira o status atualizado no PIXELPIX.",
